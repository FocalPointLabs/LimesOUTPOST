  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        accent ? "bg-accent/20" : "bg-elevated"
      )}>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-ink-muted font-mono mt-0.5">
            ...
            {venture && (
              <span className={cn(
                "ml-2 text-xs px-1.5 py-0.5 rounded-full capitalize",
      ...
      <div className="card p-4 space-y-1">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/queue" className="text-xs text-accent hover:text-accent-glow transition-colors flex items-center gap-1">
