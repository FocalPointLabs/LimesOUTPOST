...
export default function NewVenturePage() {
  ...
  function submit() {
    ...
    createVenture(
      { id: id.trim(), name: name.trim(), brand_profile, timezone },
      {
        onSuccess: (venture) => {
          setActive(venture.id);
          // Also update the schedule via PATCH
          toast.success(`Venture '${venture.name}' created.`);
          router.push("/");
        },
        onError: (err: unknown) => {
        ...
        {step === 0 && (
          <div className="space-y-4 animate-slide-up">
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-ink-muted">Lowercase, hyphens only. Used in CLI and API calls.</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={cn("input-base", errors.name && "border-danger/50")}
                placeholder="Yoga Zen"
              />
          ...
          <div className="space-y-4 animate-slide-up">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="input-base"
                placeholder="mindful, nourish, flow, restore (comma-separated)"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="input-base"
                placeholder="crush, hustle, grind (comma-separated)"
              />
            </div>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="space-y-3 animate-slide-up">
            <p className="text-sm text-ink-secondary">
              Select which workflows Beat should run automatically. You can change this later in venture settings.
            </p>
